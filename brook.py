...
#TODO research this until you've regained your confidence in it and make it 'me' agnostic
def is_me():
	def predicate(ctx):
...
#TODO role protect this command and DM those roles on load to remind them to do it
...
#TODO Fine to keep this public but make the numbers more meaningful
...
#TODO Brook has ?help, change this to a tutorial embed perhaps?
